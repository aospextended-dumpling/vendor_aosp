...
#Extended Versioning
EXTENDED_VERSION = apophis9283-V-1.6
...
EXTENDED_BUILD_DATE := $(shell date -u +%m%d-%H%M)
EXTENDED_MOD_VERSION := AospExtended-$(EXTENDED_VERSION)-$(EXTENDED_BUILD_DATE)
...
EXTENDED_DISPLAY_VERSION := AospExtended-$(EXTENDED_VERSION)
